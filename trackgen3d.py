...
from panda3d.core import Vec2, GeomVertexData, GeomTriangles, Vec3, Mat3
from trackgen import Track
from pandac.PandaModules import GeomVertexFormat, Geom, GeomVertexWriter, GeomNode
    ...
    def readFile(self, filename):
        ...
        if self.mirrored:
            ...
            if len(border_l_coll) > 0:
                ...
                for i in range(border_l_collcount):
            ...
            if len(border_l_coll) > 0:
                ...
                for i in range(border_r_collcount):
